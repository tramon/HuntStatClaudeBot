...
ANNOUNCEMENTS: list[dict] = [
    ...
    },
    {
        "prompt": (
            ...
            "Тематика може бути: про трейт, зброю, тактику, білди, компаунди, hunt showdown івенти, відомих hunt showdown стрімерів, мету, механіку або просто спостереження з байо. "
